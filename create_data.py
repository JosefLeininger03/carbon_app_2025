...
transport1 = Transport(kms=10, transport='car', fuel='diesel', co2=1, total=1, user_id=user1.id)
...
transport3 = Transport(kms=5, transport='motorbike', fuel='diesel', co2=0.7, total=0.7, user_id=user2.id)
transport4 = Transport(kms=7, transport='ferry', fuel='diesel', co2=0.8, total=0.8, user_id=user2.id)
